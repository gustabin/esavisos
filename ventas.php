    ...
    <div class="container">
    	<div class="form-group col-md-12">
        	<form  method="post" name="formVenta" id="formVenta">
        		<div class="controls">
          			<input type="text" id="criterio" name="criterio" style="width: 50%;"  placeholder="Nombre del cliente / cédula / RIF" />	  
            ...
            <div id="sresults" class="col-md-12">
   			<table id="sTable" class="tablesorter table table-bordered table-hover" style="border:1px solid #ECF0F1">
                ...
                <tr>                    
                    ...
                    <th width="10%" class="header" style="text-align: center">Status</th>
                    <th width="10%" class="header" style="text-align: center">Seleccionar</th>
                </tr>
            </thead>
            <tbody id="contenido"> 
<?php
		//================================================Recuperar registros tabla AVISOS y USUARIOS==================================================	
		if (empty($_SESSION['nombreCedula'])) 
		{
			$fechaActual= date("Y-m-d"); // obtener la fecha actual
			//$queryAvisos = ("SELECT * FROM tbl_avisos WHERE av_fechaVenta= '$fechaActual'");
			$queryAvisos = ("SELECT * FROM tbl_avisos");
		}
		
		if (!empty($_SESSION['nombreCedula'])) 
		{	
			$criterio = $_SESSION['nombreCedula'];
			//$queryUsuario = ("SELECT * FROM tbl_usuarios WHERE us_email LIKE '%$criterio%'");
