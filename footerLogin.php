					...
					<div class="row">
						...
						<div class="col-md-4">
						  <div class="newsletter">
								...
								<p><a href="registrar.php" style=" color: #09F"> Registrate</a>
                                 hoy y recibe una semana GRATIS de nuestro servicio además podrás disfrutar de una nueva edición diaria de nuestro periodico en formato PDF.</p>
							</div>
						</div>
						...
						<div class="col-md-4">
							<div class="contact-details">
								<h4>Contáctanos</h4>
								<ul class="contact">
									<li><p><i class="fa fa-map-marker"></i> <strong>Dirección:</strong> Av. Bolivar Oeste Nº 244, Edif El Siglo, Sector La Romana, Maracay, Aragua, Venezuela</p></li>
	...
	<!-- Vendor -->
		...
		<script>
			...
			*/
			...
			// Map Markers
			var mapMarkers = [{
				address: "Diario El Siglo",
				html: "<strong>el siglo</strong><br>Maracay, Aragua 2012",
				icon: {
					image: "img/pin.png",
					iconsize: [26, 46],
					iconanchor: [12, 46]
